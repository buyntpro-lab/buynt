...
-- Verify the functions return JSONB
-- SELECT proname, pg_get_functiondef(oid) FROM pg_proc 
-- WHERE proname IN ('mark_handoff_uploaded', 'mark_return_uploaded', 'confirm_handoff', 'confirm_return', 'complete_rental')
-- AND pronamespace = 'public'::regnamespace;

-- Test a function (replace with actual rental_id)
-- SELECT * FROM public.confirm_handoff('your-rental-id-here'::uuid);
